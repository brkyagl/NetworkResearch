...
Bir resim bin kelimeye bedelse, bir animasyon bir milyon kelimeye bedel olmalıdır. Bu ders kitabının web sitesi, iletim gecikmesi ile yayılma gecikmesini güzel bir şekilde gösteren ve karşılaştıran etkileşimli bir animasyon sunmaktadır. Okuyucunun bu animasyonu ziyaret etmesi şiddetle tavsiye edilir. [Smith 2009] ayrıca yayılma, kuyruk ve iletim gecikmeleri hakkında çok okunabilir bir tartışma sunmaktadır. Eğer işleme, kuyruk, iletim ve yayılma gecikmelerini sırasıyla d<sub>proc</sub>, d<sub>queue</sub>, d<sub>trans</sub> ve d<sub>prop</sub> ile gösterirsek, toplam düğüm gecikmesi şu şekilde verilir:
